...
TEST(common, ROTOR_CONTROL)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::ROTOR_CONTROL packet_in{};
    packet_in.control_mode = 113;
    packet_in.thrust = 17.0;
    packet_in.mot_throttle = {{ 45.0, 46.0, 47.0, 48.0 }};
    packet_in.rotor_thrust = {{ 157.0, 158.0, 159.0, 160.0 }};

    mavlink::common::msg::ROTOR_CONTROL packet1{};
    mavlink::common::msg::ROTOR_CONTROL packet2{};
    ...
    EXPECT_EQ(packet1.control_mode, packet2.control_mode);
    EXPECT_EQ(packet1.thrust, packet2.thrust);
    EXPECT_EQ(packet1.mot_throttle, packet2.mot_throttle);
    EXPECT_EQ(packet1.rotor_thrust, packet2.rotor_thrust);
}

#ifdef TEST_INTEROP
TEST(common_interop, ROTOR_CONTROL)
{
    mavlink_message_t msg;
    ...
    mavlink_rotor_control_t packet_c {
    ...
    mavlink_msg_rotor_control_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.control_mode, packet2.control_mode);
    EXPECT_EQ(packet_in.thrust, packet2.thrust);
    EXPECT_EQ(packet_in.mot_throttle, packet2.mot_throttle);
    EXPECT_EQ(packet_in.rotor_thrust, packet2.rotor_thrust);
