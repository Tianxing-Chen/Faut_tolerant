...
struct PolynomialTrajectory4D_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::mav_planning_msgs::PolynomialSegment4D_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::mav_planning_msgs::PolynomialSegment4D_<ContainerAllocator> >> _segments_type;
